 ...
 */
contract Deploy002_Diamond_Dollar_Governance is Script, DiamondTestHelper {
    // env variables
    ...
    function afterRun() public virtual {
        ...
        console.log("DollarToken: ", address(dollarToken));
        console.log("ProxyDollarToken: ", address(proxyDollarToken));

        console.log(
            "AccessControlFacet: ",
            address(accessControlFacetImplementation)
        );
        console.log(
            "DiamondCutFacet: ",
            address(diamondCutFacetImplementation)
        );
        console.log(
            "DiamondLoupeFacet: ",
            address(diamondLoupeFacetImplementation)
        );
        console.log("ManagerFacet: ", address(managerFacetImplementation));
        console.log("OwnershipFacet: ", address(ownershipFacetImplementation));
        console.log(
            "UbiquityPoolFacet: ",
            address(ubiquityPoolFacetImplementation)
        );

        console.log("ChainLinkPriceFeedETH: ", address(chainLinkPriceFeedEth));
        console.log(
            "ChainLinkPriceFeedLUSD: ",
            address(chainLinkPriceFeedLusd)
        );
        console.log(
        ...
        console.log("UbiquityGovernance: ", address(ubiquityGovernance));
    }
}
